...
ui_tree_view_set_on_select_thunk_ptr: unsafe { std::mem::transmute(ui_ffi::ui_tree_view_set_on_select_thunk_ptr as *const std::ffi::c_void) },
        ...
        scene_get_existing_ptr: scene_ffi_impl::scene_get_existing_ptr_editor,
        scene_root_entity_count: scene_ffi_impl::scene_root_entity_count_editor,
        scene_get_root_entity_id_at: scene_ffi_impl::scene_get_root_entity_id_at_editor,
        ...
        scene_set_script_binding_instance_id: scene_ffi_impl::scene_set_script_binding_instance_id_editor,
        scene_get_script_binding_instance_id: scene_ffi_impl::scene_get_script_binding_instance_id_editor,
        ...
        register_hot_reload_complete_callback: unsafe { std::mem::transmute(hot_reload::register_hot_reload_complete_callback as *const std::ffi::c_void) },
