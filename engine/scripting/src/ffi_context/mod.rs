...
pub struct FfiContext {
    ...
    pub ui_clear_widget_tree: ClearWidgetTreeFn,
    ...
    pub ui_create_checkbox: CreateCheckboxFn,
    pub ui_create_checkbox_in_parent: CreateCheckboxInParentFn,
    pub ui_checkbox_set_checked: CheckboxSetCheckedFn,
    pub ui_checkbox_get_checked: CheckboxGetCheckedFn,
    pub ui_checkbox_set_on_change_thunk_ptr: CheckboxSetOnChangeThunkPtrFn,
    pub ui_checkbox_set_text: CheckboxSetTextFn,
    pub ui_create_slider: CreateSliderFn,
    pub ui_create_slider_in_parent: CreateSliderInParentFn,
    pub ui_slider_set_value: SliderSetValueFn,
    pub ui_slider_get_value: SliderGetValueFn,
    pub ui_slider_set_range: SliderSetRangeFn,
    pub ui_slider_set_on_change_thunk_ptr: SliderSetOnChangeThunkPtrFn,
    pub ui_slider_set_step: SliderSetStepFn,
    pub ui_create_scroll_view: CreateScrollViewFn,
    pub ui_scroll_view_set_scroll_offset: ScrollViewSetScrollOffsetFn,
    pub ui_scroll_view_get_scroll_offset: ScrollViewGetScrollOffsetFn,
    pub ui_scroll_view_set_show_scrollbars: ScrollViewSetShowScrollbarsFn,
    pub ui_scroll_view_set_content_size: ScrollViewSetContentSizeFn,
    pub ui_scroll_view_set_on_scroll_thunk_ptr: ScrollViewSetOnScrollThunkPtrFn,
    pub ui_create_split_view: CreateSplitViewFn,
    pub ui_split_view_set_split_ratio: SplitViewSetSplitRatioFn,
    pub ui_split_view_get_split_ratio: SplitViewGetSplitRatioFn,
    pub ui_split_view_set_min_ratio: SplitViewSetMinRatioFn,
    pub ui_split_view_set_max_ratio: SplitViewSetMaxRatioFn,
    pub ui_split_view_set_on_ratio_change_thunk_ptr: SplitViewSetOnRatioChangeThunkPtrFn,
    // Image
    pub ui_create_image: CreateImageFn,
    pub ui_image_set_texture_id: ImageSetTextureIdFn,
    pub ui_image_get_texture_id: ImageGetTextureIdFn,
    pub ui_image_set_scale_mode: ImageSetScaleModeFn,
    pub ui_image_set_uv: ImageSetUvFn,
    ...
    pub ui_tree_node_set_selected: TreeNodeSetSelectedFn,
    ...
    pub scene_get_existing_ptr: SceneGetExistingPtrFn,
    pub scene_root_entity_count: SceneRootEntityCountFn,
    pub scene_get_root_entity_id_at: SceneGetRootEntityIdAtFn,
    ...
    pub scene_set_script_binding_instance_id: SceneSetScriptBindingInstanceIdFn,
    pub scene_get_script_binding_instance_id: SceneGetScriptBindingInstanceIdFn,
    ...
    pub scene_set_parent: SceneSetParentFn,
    pub scene_get_parent: SceneGetParentFn,
    pub scene_get_child_count: SceneGetChildCountFn,
    pub scene_get_child_id: SceneGetChildIdFn,
    ...
    pub register_hot_reload_complete_callback: RegisterHotReloadCompleteCallbackFn,
    ...
    pub ui_widget_set_background_color: SetWidgetBackgroundColorFn,
    pub ui_label_set_wrap_mode: SetLabelWrapModeFn,
    pub event_dispatcher_ptr: EventDispatcherHandle,
    ...
    pub ui_widget_get_total_count: WidgetGetTotalCountFn,
    pub ui_debug_dump_tree_to_buffer: DebugDumpTreeToBufferFn,
    pub capture_screenshot_to_file: CaptureScreenshotToFileFn,
