...
pub enum TextureFormat {
    ...
    Depth16, Depth24, Depth32, Depth24Stencil8, Depth32Stencil8,
}
...
impl TextureFormat {
    pub fn size(&self) -> usize {
        match self {
            ...
            TextureFormat::Rgba8Unorm | TextureFormat::Rgba8Snorm | TextureFormat::Rgba8Uint | TextureFormat::Rgba8Sint |
            TextureFormat::Bgra8Unorm | TextureFormat::Bgra8Snorm => 4,
    ...
    pub fn is_depth(&self) -> bool {
        matches!(self, TextureFormat::Depth16 | TextureFormat::Depth24 | TextureFormat::Depth32 | TextureFormat::Depth24Stencil8 | TextureFormat::Depth32Stencil8)
    }
    
    pub fn is_stencil(&self) -> bool {
        matches!(self, TextureFormat::Depth24Stencil8 | TextureFormat::Depth32Stencil8)
    }
}

#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash)]
pub enum TextureType {
    Texture1D, Texture2D, Texture3D, Texture2DArray, TextureCube, TextureCubeArray,
}
...
impl TextureDesc {
    ...
    pub fn render_target(format: TextureFormat, width: u32, height: u32) -> Self {
        Self {
            ...
            array_layers: 1,
            samples: 1,
            usage: TextureUsage { sampled: true, render_target: true, ..Default::default() },
        }
    }
    ...
    pub fn depth_target(format: TextureFormat, width: u32, height: u32) -> Self {
        Self {
            ...
            array_layers: 1,
            samples: 1,
            usage: TextureUsage { sampled: true, depth_stencil: true, ..Default::default() },
        }
    }
}
...
pub struct TextureUsage {
    pub sampled: bool, pub storage: bool, pub render_target: bool, pub depth_stencil: bool, pub transfer_src: bool, pub transfer_dst: bool,
}