...
use crate::texture::{TextureFormat, TextureDesc};
...
impl UIDrawData {
    ...
    pub fn add_rect(&mut self, x: f32, y: f32, width: f32, height: f32, r: f32, g: f32, b: f32, a: f32) {
    ...
    pub fn add_line(&mut self, x1: f32, y1: f32, x2: f32, y2: f32, r: f32, g: f32, b: f32, a: f32, width: f32) {
        let dx = x2 - x1;
        let dy = y2 - y1;
...
impl UIPipelineDesc {
    pub fn new() -> Self {
        Self {
            shader_vert: ShaderDesc::vertex(ShaderSource::Spirv(Self::load_shader(include_bytes!("../../shaders/rotation.vert.spv")))),
            shader_frag: ShaderDesc::fragment(ShaderSource::Spirv(Self::load_shader(include_bytes!("../../shaders/rotation.frag.spv")))),
        }
    }
